...
public class OutputView {
    ...
    public static void printPrize(HashMap<String,Integer> prizeResult){
        ...
        System.out.println("---");
        System.out.println(PRINT_FIFTH_PRIZE_RESULT + prizeResult.get("fifthPrize") + "개");
        System.out.println(PRINT_FOURTH_PRIZE_RESULT + prizeResult.get("fourthPrize") + "개");
        System.out.println(PRINT_THIRD_PRIZE_RESULT + prizeResult.get("thirdPrize") + "개");
        System.out.println(PRINT_SECOND_PRIZE_RESULT + prizeResult.get("secondPrize") + "개");
        System.out.println(PRINT_FIRST_PRIZE_RESULT + prizeResult.get("firstPrize") + "개");
    }
